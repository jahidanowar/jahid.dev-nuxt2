          ...
          <div class="grid sm:grid-cols-2 gap-5 mt-10">
            <div class="info-box p-5 rounded-lg bg-gray-100 dark:bg-gray-800">
              <div class="flex items-center mb-2">
                ...
                <span class="font-medium ml-2">Industry</span>
              </div>
              {{ project.industry }}
            </div>
            <div class="info-box p-5 rounded-lg bg-gray-100 dark:bg-gray-800">
              <div class="flex items-center mb-2">
                ...
                <span class="font-medium ml-2">Location</span>
              </div>
              {{ project.location }}
            </div>
            <div class="info-box p-5 rounded-lg bg-gray-100 dark:bg-gray-800">
              <div class="flex items-center mb-2">
                ...
                <span class="font-medium ml-2">Stack</span>
              </div>
              {{ project.tech_stack }}
            </div>
            <nuxt-link
              :to="{ name: 'contact' }"
              class="info-box p-5 rounded-lg bg-primary-500 text-primary-50"
            >
              <div class="flex items-center mb-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="font-medium ml-2">Have a project?</span>
              </div>
              Contact me
            </nuxt-link>
          </div>
...
export default {
  async asyncData({ $axios, params, error }) {
    const projects = await $axios.$get(
      '/project/?slug=' + params.slug + '&_embed=1'
    )
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'og:image',
          property: 'og:image',
          content: this.project._embedded['wp:featuredmedia']['0'].source_url
        },
        {
          hid: 'og:title',
          property: 'og:title',
          content: this.project.title.rendered
        },
        {
          hid: 'og:description',
