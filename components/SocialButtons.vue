<template>
  <div class="flex">
    <social-icon link="https://twitter.com/@jahidDev"
      ><svg
        viewBox="0 0 24 24"
      ...
      >
        ...
        /></svg
    ></social-icon>
    <social-icon link="https://instagram.com/jahidDev" class="ml-2">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-4"
      ...
      >
        ...
        /></svg
    ></social-icon>
    <social-icon link="https://www.linkedin.com/in/jahidanowar/" class="ml-2"
      ><svg
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        class="h-4"
    ...
    ></social-icon>
    <social-icon
      link="https://www.youtube.com/channel/UCeLvns7Gwo_aq18-GKT-yww"
      class="ml-2"
      ><svg
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
    ...
    ></social-icon>
    <slot></slot>
    <social-icon link="https://facebook.com/jahid500k" class="ml-2"
      ><svg
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        class="h-4"
